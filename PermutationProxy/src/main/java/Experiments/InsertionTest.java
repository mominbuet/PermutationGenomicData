...
public class InsertionTest {
    ...
    public static void main(String[] args) throws URISyntaxException, InterruptedException {
        ...
        String destUri = "ws://" + config.getString("Host") + ":" + config.getString("SocketPort") + "/" + config.getString("SocketEndpoint") + "/endpoint_permutation_insertperm";//endpoint_permutation_insert
        Date d11 = new Date();

        QueryDB queryDB = new QueryDB();
        snips = queryDB.getAllSnip(TYPE);
